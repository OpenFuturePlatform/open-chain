...
import io.openfuture.chain.component.converter.transaction.unconfirmed.impl.UDelegateTransactionEntityConverter
...
) : DefaultUTransactionService<UDelegateTransaction, DelegateTransactionData>(repository, walletService, nodeClock,
    entityConverter), UDelegateTransactionService {
