...
class DefaultPendingBlockHandlerTests : ServiceTests() {
    ...
    fun handleApproveMessageShouldPrepareApproveMessage() {
        ...
        val payload = MainBlockPayload("transactionMerkleHash", "stateMerkleHash", "receiptMerkleHash")
        val rewardTransactionMessage = createRewardTransactionMessage(1L)
        val pendingBlock = PendingBlockMessage(2L, "previousHash", 1L, hash, "signature",
            publicKey, payload.transactionMerkleHash, payload.stateMerkleHash, payload.receiptMerkleHash,
            rewardTransactionMessage, listOf(), listOf(), listOf(), listOf(), listOf(), listOf())
