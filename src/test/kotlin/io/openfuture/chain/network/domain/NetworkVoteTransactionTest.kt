...
class NetworkVoteTransactionTest {
    ...
    private val entity = VoteTransactionMessage(VoteTransactionData(1, 1, "recipientAddress", "senderKey", 1, "delegateKey"),
...
/*
    ...
    fun readShouldFillEntityWithExactValuesFromBuffer() {
        val actualEntity = VoteTransactionMessage::class.java.newInstance()
